...
import (
	...
	"https://github.com/stream-innovations/streampayments-platfrom/internal/db/connection/pg"
	...
	"https://github.com/stream-innovations/streampayments-platfrom/internal/provider/tatum"
	...
	"https://github.com/stream-innovations/streampayments-platfrom/pkg/api-kms/v1/client"
...
func (loc *Locator) DB() *pg.Connection {
	loc.init("db", func() {
		db, err := pg.Open(loc.ctx, loc.config.StreamPay.Postgres, loc.logger)
		if err != nil {

...
import (
	...
	v1 "https://github.com/stream-innovations/streampayments-platfrom/internal/server/http/internalapi"
...
// WithDashboardAPI setups routes for Merchant's Dashboard (app.streampayments.co)
...
// WithMerchantAPI setups Merchant's API routes (api.streampayments.co)

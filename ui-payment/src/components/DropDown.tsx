    ...
    return (
        <>
            <button
                type="button"
                id="currency_list"
                className={`relative h-12 flex props.items-center appearance-none bg-white bg-clip-padding bg-no-repeat border border-main-blue-3 rounded-xl w-full py-3 px-4 ${
            ...
            >
                ...
                {isFocused && (
                    <>
                        ...
                        <ul className="absolute top-14 left-1/2 -translate-x-1/2 z-50 max-h-96 overflow-auto scrollbar-thumb-gray-900 bg-white bg-clip-padding bg-no-repeat border border-main-blue-3 rounded-xl w-full py-3 px-4">
                            {props.items.map((child, idx) => (
                                <li
                                    className={`flex h-12 props.items-center relative ${
                                        props.items[idx].key !== "emptyValue" ? "pl-8" : ""
                                    } hover:text-main-blue-2 ${

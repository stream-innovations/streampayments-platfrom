...
const CopyButton: React.FC<Props> = ({textToCopy, displayText}) => {
    ...
    const btnCopiedStyle = copied ? "bg-main-blue-3 text-center" : "";
    ...
    return (
        <div className="relative w-full mb-6">
            <button
                ...
                className={
                    btnCopiedStyle +
                    " h-12 py-3 px-4 text-left text-sm border transition-colors rounded-xl transition w-full border-main-blue-3"
                }

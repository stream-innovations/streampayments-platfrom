        ...
        <>
            {paymentLink ? (
                <div className="relative">
                    ...
                    <button
                        className="relativeopacity-50 border rounded-3xl bg-main-blue-1 border-main-blue-1 h-14 font-medium text-xl text-white flex items-center justify-center basis-full w-full"
                        onClick={() => createLink()}
                    >
                        Pay with crypto
